...
hoistedDependencies:
  ...
  nanoid@3.3.11:
    nanoid: private
  packages/core:
    '@personalizer/core': private
  packages/react:
    '@personalizer/react': private
  packages/renderer-client-canvas:
    '@personalizer/renderer-client-canvas': private
  packages/renderer-server-chromium:
    '@personalizer/renderer-server-chromium': private
  packages/shared-test-vectors:
    '@personalizer/shared-test-vectors': private
  packages/spec:
    '@personalizer/spec': private
  pathe@1.1.2:
    pathe: private
  pathval@2.0.1:
    pathval: private
...
pendingBuilds: []
prunedAt: Thu, 19 Feb 2026 01:48:54 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
  '@spa': https://nexus.alaricsecurities.net/repository/alaric-npm/
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-gnu@4.57.1'
  - '@rollup/rollup-win32-x64-msvc@4.57.1'
storeDir: /Users/keremdemirer/Library/pnpm/store/v3
